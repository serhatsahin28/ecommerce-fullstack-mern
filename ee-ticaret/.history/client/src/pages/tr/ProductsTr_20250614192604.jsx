...
const validCategories = ['elektronik', 'moda', 'kitaplar', 'ev_ofis'];
if (!validCategories.includes(rawSlug)) {
  return <Navigate to={`/${lang}/404`} />;
}
      ...
      <Container className="py-5">
        <header className="text-center mb-4">
          <h1 className="display-5 fw-bold text-primary">
            {categoryKey ? `${categoryNames[categoryKey]} Ürünler` : 'Ürünler'}
          </h1>
          <p className="text-muted">Bu kategorideki en iyi ürünleri keşfedin</p>
        </header>
