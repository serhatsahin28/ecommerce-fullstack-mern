...
import { Navigate } from 'react-router-dom'; // ekle
...
export default function ProductsEn() {
  ...
  useEffect(() => {
    ...
    }, 50); // Ürünler gelmeden önce scroll yukarıya sabitlenir
  }, [categoryKey]);

  // ❗️Geçersiz slug varsa doğrudan NotFoundTr sayfasına yönlendir
  if (!categoryKey) {
                ...
                <Col key={product.id}>
                  <Card className="h-100 shadow-sm">
                    ...
                    <Card.Body>
                      ...
                      <div className="fw-bold text-primary mb-3">${product.price}</div>
