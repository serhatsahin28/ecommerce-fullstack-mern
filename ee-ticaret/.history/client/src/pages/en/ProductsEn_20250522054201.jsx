...
import { FaSearch, FaListUl, FaExclamationCircle } from 'react-icons/fa';
          ...
          {filteredProducts.length > 0 ? (
            ...
            <Card className="text-center p-5">
              <Card.Body>
                ...
                <Card.Text>No matching products were found for your search.</Card.Text>
              </Card.Body>
            </Card>
          )}
        </Suspense>
