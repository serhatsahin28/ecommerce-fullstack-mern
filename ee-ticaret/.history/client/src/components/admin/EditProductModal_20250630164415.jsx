      ...
      <Modal.Body>
        ...
        {editProduct && (
          <Form>
                ...
                <Card className="shadow-sm border-0">
                  ...
                  <Card.Body className="d-flex flex-column align-items-center">
                    <Image
                      ...
                      className="mb-3"
                    />
                    <Form.Label className="fw-bold text-dark">Yeni Resim Yükle</Form.Label>
                    <Form.Control
                      type="file"
                      accept="image/*"
              ...
              <Col md={6}>
                <Card className="shadow-sm border-0">
                  ...
                  <Card.Body>
                    ...
                    <Form.Label className="fw-bold text-dark">Yeni Resimler Yükle</Form.Label>
                    <Form.Control
                      type="file"
                      accept="image/*"
                      multiple
            ...
            {/* Türkçe İçerik */}
            <h5 className="fw-bold text-dark mb-3">Türkçe İçerik</h5>
            <Form.Group className="mb-3">
            ...
            {/* İngilizce İçerik */}
            <h5 className="fw-bold text-dark mb-3">English Content</h5>
            <Form.Group className="mb-3">
