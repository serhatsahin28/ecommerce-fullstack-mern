...
const AddProductModal = ({ show, onHide, onNotification, onProductAdded, product }) => {
    ...
    const handleAddProduct = async () => {
        ...
        try {
            ...
            if (newProduct.imageFile) {
                formData.append('mainImage', newProduct.imageFile);  // Tek ana resim
            }

            if (newProduct.newImageFiles && newProduct.newImageFiles.length > 0) {
                newProduct.newImageFiles.forEach(file => {
                    formData.append('images', file);  // Diğer çoklu resimler
                });
            }
            ...
            console.log("addedProductaddedProduct: " + addedProduct);
            onNotification('Ürün başarıyla eklendi!', 'success');
            onProductAdded && onProductAdded(addedProduct.product);
            onHide();
