// components/admin/AddProductHeader.jsx
import React, { useState } from 'react';
import { Col, Card, Row, Form, Button, Alert, Image, InputGroup, Spinner } from 'react-bootstrap';

const AddProductHeader = ({ onNotification, onProductAdded }) => {
  ...
  const validateProduct = () => {
    ...
    if (!tr.description || tr.description.trim() === '') {
  ...
  const handleAddProduct = async () => {
    ...
    try {
      ...
      // Ürün bilgilerini FormData'ya ekle
      ...
      // Ana component'e yeni ürün eklendiğini bildir
      if (onProductAdded) {
  ...
  return (
    <div>
      <h3 className="mb-4">Yeni Ürün Ekle</h3>
      ...
      <Form>
        ...
        <Row className="mb-4">
          <Col md={6}>
            ...
            {newProduct.translations.tr.features.map((feat, idx) => (
              <InputGroup className="mb-2" key={`tr-feature-${idx}`}>
                ...
                <Button 
                  ...
                  disabled={newProduct.translations.tr.features.length === 1}
                >
                  &minus;
                </Button>
              </InputGroup>
          ...
          <Col md={6}>
            ...
            {newProduct.translations.en.features.map((feat, idx) => (
        ...
        <Row className="mb-4">
          <Col className="d-flex justify-content-end gap-2">
            ...
            >
              {adding && <Spinner animation="border" size="sm" />}
              Ürün Ekle
            </Button>
          </Col>
        </Row>
