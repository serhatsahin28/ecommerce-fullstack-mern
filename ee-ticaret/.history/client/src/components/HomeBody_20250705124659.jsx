...
export default function HomeBody() {
  ...
  const allProductsWithCategory = useMemo(() => {
    ...
    // `flatMap` ile tüm kategorileri gezip, her birinden gelen ürünleri tek bir diziye yayıyoruz.
    return homeContent.categories.flatMap(category => 
      // `map` ile o kategoriye ait her bir ürün objesini alıyoruz...
      (category.products || []).map(product => ({
        ...product, // ...ürünün mevcut tüm özelliklerini kopyalıyoruz...
        category_key: category.category_key // ...ve yanına üst objenin `category_key` bilgisini ekliyoruz.
      }))
    );
  }, [homeContent]);
