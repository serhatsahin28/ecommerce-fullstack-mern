...
const EditProductModal = ({
  ...
  const handleUpdate = async () => {
    ...
    // const updateProductImages = async (productId, updatedImages) => {
    //   try {
    //     const response = await fetch(`http://localhost:5000/admin/updateProduct/${productId}`, {
    //       method: 'PUT',
    //       headers: {
            ...
            <Form.Group className="mb-3" controlId="editProductImages">
                  ...
                  <div key={idx} style={{ position: 'relative', marginRight: 10, marginBottom: 10 }}>
                    ...
                    <Button
                      ...
                      onClick={async () => {
                        ...
                        try {
                          const response = await fetch(`/admin/updateProduct/${editProduct._id}`, {
                            method: 'PUT',
                          ...
                          // İstersen response'u da işleyebilirsin
                          // const data = await response.json();
                        } catch (error) {
              ...
              <Form.Control
                ...
                onChange={e => {
                  ...
                  const newFilePaths = files.map(file => `/images/${file.name}`);
