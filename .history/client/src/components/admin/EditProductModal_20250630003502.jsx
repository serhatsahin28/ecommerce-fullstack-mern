...
const EditProductModal = ({
  ...
  return (
    ...
    <div className="d-flex flex-wrap mb-2">
      ...
      {/* Yeni seçilen dosyalar için önizleme */}
        ...
        <div key={`new-${idx}`} style={{ position: 'relative', marginRight: 10, marginBottom: 10 }}>
          ...
          <Button
            ...
            onClick={() => {
              ...
              setEditProduct(prev => ({ ...prev, newImageFiles: newFiles }));
            }}
          >
            X
          </Button>
    ...
    <Form.Control
      ...
      onChange={e => {
        ...
        // Yeni dosyaları state'e ekle, aynı zamanda önizleme için yeni dosyalar da tutuluyor
        setEditProduct(prev => ({
          ...prev,
          images: prev.images ? [...prev.images] : [], // eski url listesi
