...
const handleUpdate2 = async () => {
  ...
  try {
    ...
    // Serverdaki hala kullanılacak resim URL dizisi (mesela DB'de kalacak)
    ...
    await axios.put(
      `http://localhost:5000/admin/updateProduct/${editProduct._id}`,
      formData,
      { headers: { 'Content-Type': 'multipart/form-data' } }
    );

    // Local state güncellemesi yapılabilir burada

    setShowEditModal(false);
    setEditProduct(null);
    onNotification('Ürün başarıyla güncellendi!');
  } catch (err) {
