...
import React, { useEffect, useState, useContext } from 'react'; // ✅ useContext eklendi
import {
...
import { CartContext } from '../common/CartContext'; // ✅ context import edildi
import { isAuthenticated } from '../../utils/auth'; // ekle
const Header = () => {
        ...
        <Navbar.Collapse id="main-nav">
          <Nav className="me-auto align-items-center">
            ...
            >
              ...
              >
                {categoriesData?.title || 'Categories'}
              </Dropdown.Toggle>
