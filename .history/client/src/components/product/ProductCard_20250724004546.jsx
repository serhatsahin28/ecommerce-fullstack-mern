      ...
      <Card className="h-100 shadow-sm d-flex flex-column">
        ...
        >
          <Card.Img
            ...
            alt={product.name}
            style={{
              objectFit: 'contain',        // Görüntüyü kırpmaz, küçültmez
              maxHeight: '200px',          // Sabit yükseklik (daha da özelleştirilebilir)
              width: '100%',               // Kart genişliği kadar uzar
              backgroundColor: '#f8f9fa',  // Boş kalan alanlarda arka plan (isteğe bağlı)
            }}
          />
