...
import { CartContext } from '../../components/common/CartContext'; // doğru yolu kontrol et

const ProductCard = ({ product }) => {
  const { t, i18n } = useTranslation('products');
  const currentLanguage = i18n.language;

  const { addToCart } = useContext(CartContext); // ✅ burada bağlanıyor
  ...
  return (
    <Card className="h-100 shadow-sm">
      ...
      <div className="px-3 pb-3">
        ...
        <Button variant="danger" className="w-100" onClick={() => addToCart(product)}>
