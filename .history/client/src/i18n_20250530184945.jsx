...
i18n
  ...
  .init({
    resources: {
      en: { common: enCommon, home: enHome, products: enProducts, categories: enCategories },
      tr: { common: trCommon, home: trHome, products: trProducts, categories: trCategories }
    },
    lng: 'tr',
    fallbackLng: { default: ['tr', 'en'], products: ['common'], categories: ['common'] },
