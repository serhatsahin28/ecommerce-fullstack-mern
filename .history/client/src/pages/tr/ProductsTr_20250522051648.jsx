// ProductTr.jsx (pages/tr/ProductTr.jsx)
...
export default function ProductsTr() {
  ...
  const categoryKey = categorySlugToKey[slug?.toLowerCase()];
    ...
    return (
      <Container className="py-5 text-center">
        <Alert variant="warning" className="shadow-sm">
          <FaExclamationCircle className="me-2" /> Geçersiz kategori: <strong>{slug}</strong>
        </Alert>
      </Container>
    );
  }
