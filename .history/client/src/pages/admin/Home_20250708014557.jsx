...
const AdminHome = () => {
  ...
  // handleImageUpload fonksiyonunu düzeltelim
const handleImageUpload = async (event) => {
  ...
  try {
    // Content-Type header'ını kaldırdık, FormData ile otomatik olarak multipart/form-data olur
    const response = await fetch(`http://localhost:5000/admin/home/upload/${homePageData._id}`, {
      method: 'POST',
      body: formData // headers kısmını tamamen kaldırdık
    });
...
// saveImage fonksiyonunu da güncelleyelim
const saveImage = () => {
