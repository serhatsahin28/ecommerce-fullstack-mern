// src/pages/tr/ProductDetail.jsx
...
const validCategories = ['electronics', 'fashion', 'books', 'sports', 'home_office'];
const trSlugToKey = {
...
export default function ProductDetailTR() {
  ...
  const categoryKey = trSlugToKey[category];

  // Geçersiz kategori durumunda 404'e yönlendir
  if (!categoryKey || !validCategories.includes(categoryKey)) {
  ...
  const tData = product.translations?.[currentLang] || product.translations?.tr || {};
