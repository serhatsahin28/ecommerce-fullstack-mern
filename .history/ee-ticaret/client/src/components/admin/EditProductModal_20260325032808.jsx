...
const colorMap = {
    "kırmızı": "red", "mavi": "blue", "yeşil": "green", "siyah": "black", "beyaz": "white",
    "sarı": "yellow", "mor": "purple", "turuncu": "orange", "pembe": "pink", "gri": "gray",
    "lacivert": "dark blue", "kahverengi": "brown", "altın": "gold", "gümüş": "silver",
    // Tersini de ekleyebilirsin veya otomatik kontrol edebiliriz
};
        ...
        if (editProduct.variantType !== 'none') {
            const processed = editProduct.colorGroups.map((group, gIdx) => {
                ...
                return {
                    ...
                    color_name: {
                        tr: group.group_name || '',
                        en: group.group_name_en || group.group_name || ''
                    }
                };
            });
