      ...
      <Container>
        ...
        <Row className="align-items-center">
          ...
          <Col md={6} className="text-center text-md-end">
            <a href="facebook.com" className="text-white me-3" aria-label="Facebook">
              <FaFacebookF />
            </a>
            <a href="twitter.com" className="text-white me-3" aria-label="Twitter">
              <FaTwitter />
            </a>
            <a href="instagram.com" className="text-white" aria-label="Instagram">
              <FaInstagram />
            </a>
          </Col>
        </Row>
