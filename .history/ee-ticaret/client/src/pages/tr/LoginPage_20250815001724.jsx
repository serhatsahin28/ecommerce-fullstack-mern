...
const LoginPageTr = () => {
  ...
  const handleLoginSuccess = () => {
    setShowSuccess(true);
    setTimeout(() => setShowSuccess(false), 3000); // 3 saniye sonra kaybolur
  };
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (!toastShown.current) {
        toast.success('Giriş başarılı!', { autoClose: 3000, toastId: 'login-success' });
        toastShown.current = true; // artık bir daha gösterilmez
      }
