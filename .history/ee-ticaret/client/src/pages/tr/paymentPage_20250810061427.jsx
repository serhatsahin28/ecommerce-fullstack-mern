...
const PaymentPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const paymentData = {
      ...
      // DÜZELTME: savedCardToken kaldırıldı
    ...
    try {
      // DÜZELTME: savedCardToken logları kaldırıldı
      console.log("Payment data:", paymentData);
      let cardAy=selectedSavedCard.son_kullanma.split('/')[0];
      console.log("selectedSavedCard data:", selectedSavedCard);
      console.log("cardAy data:", cardAy);

      const paymentResponse = await axios.post('http://localhost:5000/pay', paymentData);

      // ... başarılı işlemler ...
    } catch (err) {
      // DÜZELTME: Hata mesajlarını daha detaylı hale getirdik
  ...
  // DÜZELTME: Bu fonksiyon kullanılmıyor, kaldırılabilir
