...
const PaymentPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const paymentData = {
      ...
      savedCardId:
        selectedSavedCard && selectedSavedCard.token
          ? null // Token varsa ID göndermeye gerek yok
          : selectedSavedCard?._id || null,
    ...
    try {
      ...
      await axios.post(`${import.meta.env.VITE_API_URL}/pay', paymentData, {
        headers: {
          "Content-Type": "application/json",
          ...(paymentData.savedCardId ? { Authorization: `Bearer ${token}` } : {})
        }
      });
