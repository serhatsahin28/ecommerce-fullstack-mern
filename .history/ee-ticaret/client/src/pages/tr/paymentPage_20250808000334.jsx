        ...
        <Col lg={10}>
          ...
          <Card className="mb-4 shadow border-primary">
            ...
            <Card.Body>
                            ...
                            <Card.Body className="py-3">
                              <div className="d-flex align-items-center">
                                ...
                                <div>
                                  ...
                                  <div className="text-muted small">{savedCard.kart_numarasi}</div>
              ...
              {/* Kayıtlı kart seçildiğinde sadece CVC iste */}
              {selectedSavedCard && (
                <div className="mb-4 p-3 border rounded bg-light">
                  ...
                  <div className="d-flex align-items-center mb-3">
                    ...
                    <div>
                      ...
                      <div className="text-muted small">{selectedSavedCard.kart_numarasi}</div>
