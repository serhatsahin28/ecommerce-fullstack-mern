...
import { CartContext } from '../../context/CartContext'; // ✅ CartContext eklendi
...
const LoginPageTr = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // ✅ Önce local ve backend sepeti senkronize et
      await fetchCart();

      setSuccess('Giriş başarılı!');
      toast.success('Giriş başarılı!');

      // ✅ Direkt sepet sayfasına veya anasayfaya yönlendir
      navigate('/tr/cart');
    } catch (err) {
