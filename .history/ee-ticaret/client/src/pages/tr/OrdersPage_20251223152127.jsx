...
const OrdersPage = () => {
  ...
  const confirmCancelOrder = () => {
    ...
    alert(`${orderToCancel} nolu sipariş iptal edildi.`);
  ...
  return (
    <div className="bg-light min-vh-100">
      ...
      <Container className="py-5">
        ...
        <Accordion activeKey={activeAccordion} flush>
          {filteredOrders.map((order) => (
            <Card key={order._id.$oid} className="mb-3 border-0 shadow-sm">
      ...
      <Modal show={showCancelModal} onHide={() => setShowCancelModal(false)}>
        ...
        <Modal.Body>
          <p>{orderToCancel} nolu siparişi iptal etmek istediğinizden emin misiniz?</p>
        </Modal.Body>
        <Modal.Footer>
