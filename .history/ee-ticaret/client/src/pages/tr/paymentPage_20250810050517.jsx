...
const PaymentPage = () => {
  ...
  const payWithSavedCard = async (savedCard) => {
    const res = await fetch("/pay-with-saved-card", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        kart_numarasi: savedCard.kart_numarasi,
        son_kullanma: savedCard.son_kullanma,
        cvv: savedCard.cvv,
        buyerInfo,
        basketItems,
        price: totalPrice
