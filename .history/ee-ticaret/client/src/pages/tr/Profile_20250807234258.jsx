                        ...
                        <Card className="h-100 border-0 shadow-sm">
                          <Card.Header className="bg-danger text-white d-flex justify-content-between align-items-center">
                            <div>
                              ...
                              <span className="fw-bold">{kart.kart_ismi}</span>
                            </div>
                          ...
                          <Card.Body>
                            <ListGroup variant="flush">
                              <ListGroup.Item>
                                <b>Kart Numarası:</b> {kart.kart_numarasi}
                              </ListGroup.Item>
                              <ListGroup.Item>
                                <b>Son Kullanma:</b> {kart.son_kullanma}
                              </ListGroup.Item>
                              <ListGroup.Item>
