...
const ViewOrdersPage = () => {
  ...
  useEffect(() => {
    // Gerçek API çağrısı yerine mock veri kullanımı
    const fetchOrders = async () => {
      try {
        ...
        // API'den gelen gerçek sipariş verileri
        const response = {
          success: true,
          totalOrders: 3,
          orders: [
            ...
            },
            {
              ...
              payment: {
                method: "cash",
                status: "pending",
                iyzicoReference: null,
                date: "2025-08-04T12:30:15.000Z"
              },
              orderStatus: "shipped",
              orderCode: "ORD-709064123",
              createdAt: "2025-08-04T12:30:15.000Z",
              __v: 0
            },
            {
              _id: "68928c31332568cd46bdcf80",
              userId: null,
              email: "musteri@example.com",
              firstName: "Ahmet",
              lastName: "Yılmaz",
              ...
              payment: {
                method: "iyzico",
                status: "success",
                iyzicoReference: "25100888",
                date: "2025-08-01T10:15:30.000Z"
              },
              orderStatus: "delivered",
              orderCode: "ORD-809064456",
        ...
        if (response.success) {
          ...
          setVariant('success');
          setMessage(`Hoş geldiniz! Toplam ${response.totalOrders} siparişiniz bulundu.`);
        } else {
          setVariant('warning');
          setMessage(response.message || 'Siparişler getirilemedi.');
        }
      } catch (err) {
        setVariant('danger');
