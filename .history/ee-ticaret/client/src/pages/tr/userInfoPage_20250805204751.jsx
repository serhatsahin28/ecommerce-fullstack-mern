...
const UserInfoPage = () => {
  // const navigate = useNavigate(); // ✅ Bu satırı kaldır
  ...
  const navigateToPayment = () => {
    ...
    // PaymentPage'e yönlendir - bu kısmı kendi routing sisteminize göre değiştirin
    // Örnek: React Router kullanıyorsanız
    // navigate('/payment');
    // veya window.location kullanıyorsanız
