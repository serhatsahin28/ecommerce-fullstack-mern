          ...
          <Col md={6}>
            <Form.Group>
              ...
              <Form.Control
                type="text"
                name="tcKimlikNo"
                value={userInfo.tcKimlikNo}
                onChange={handleChange}
                readOnly={!!userInfo.tcKimlikNo}
