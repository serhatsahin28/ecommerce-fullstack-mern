...
const PaymentPage = () => {
  ...
  useEffect(() => {
    ...
    // First check guestInfo, then use userAddress
    if (storedGuestInfo) {
      ...
      // Get address info when logged in
      if (token) {
        ...
        const fetchUserInfo = async () => {
          try {
            ...
            // Combine address data with user info
            setGuestInfo({
              ...addressData,
  ...
  const handleChange = (e) => {
    ...
    if (name === 'expireMonth') {
      ...
      // DÜZELTME: Fazladan parantez kaldırıldı
  ...
  const saveOrderToDatabase = async (paymentResponse) => {
    try {
      ...
      if (orderResponse.data.success) {
        ...
        throw new Error(orderResponse.data.message || 'Failed to save order');
      }
    } catch (error) {
    ...
    <Container className="py-5">
                  ...
                  {guestInfo ? (
                    <ListGroup variant="flush">
                      <ListGroup.Item className="d-flex align-items-center">
                        ...
                        <span>{guestInfo.name} {guestInfo.surname}</span>
                      </ListGroup.Item>
                      <ListGroup.Item className="d-flex align-items-center">
      ...
      >
        ...
        <Modal.Body className="p-4">
          ...
          {/* Show account creation offer only if not logged in */}
          {!isLoggedIn && (
            <>
              <h5 className="text-center mb-3">Create an account to track your orders easily</h5>
                ...
                <div className="col-md-6 mb-3">
                  <Card className="h-100 border-0 shadow-sm">
                    <Card.Body className="text-center">
                      ...
                      <p className="text-muted small">Access members-only promotions</p>
                    </Card.Body>
                  </Card>
                </div>
                <div className="col-md-6 mb-3">
