...
const PaymentPageEn = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Additional validation only for new cards
    if (!selectedSavedCard) {
      ...
      // Validation for saved cards
      if (!card.cvc || card.cvc.length < 3) {
        setError('CVC code is required for saved cards.');
        setLoading(false);
        return;
      }
    }
                ...
                <div className="col-md-6 mb-3">
                  <Card className="h-100 border-0 shadow-sm">
                    <Card.Body className="text-center">
                      ...
                      <p className="text-muted small">Track all your orders from one place</p>
                    </Card.Body>
                  </Card>
                </div>
                <div className="col-md-6 mb-3">
                  <Card className="h-100 border-0 shadow-sm">
                    <Card.Body className="text-center">
                      ...
                      <p className="text-muted small">Your address and payment info will be saved</p>
                    </Card.Body>
                  </Card>
                </div>
                <div className="col-md-6 mb-3">
                  <Card className="h-100 border-0 shadow-sm">
                    <Card.Body className="text-center">
                      ...
                      <p className="text-muted small">Enjoy member-only campaigns</p>
                    </Card.Body>
                  </Card>
                </div>
                <div className="col-md-6 mb-3">
                  <Card className="h-100 border-0 shadow-sm">
                    <Card.Body className="text-center">
                      ...
                      <p className="text-muted small">See the status of your order in real-time</p>
                    </Card.Body>
                  </Card>
                </div>
              </div>
