    ...
    try {
      ...
      const orderData = {
        ...
        cart: cart.map(item => ({
          ...
          name: item.translations?.en?.name || item.translations?.tr?.name || 'Product',
                            ...
                            <ListGroup.Item key={index} className="d-flex justify-content-between align-items-center border-0 px-0">
                              <div>
                                <div className="fw-medium">
                                  {item.translations?.en?.name || item.translations?.tr?.name || 'Product'}
                                </div>
                                <div className="text-muted small mt-1">
                                  {item.category_title || 'Category'} • {item.quantity || 1} item(s)
                                </div>
                              </div>
