                        ...
                        <>
                            ...
                            {selectedOrder.orderStatus === 'cancel_pending' && (
                                <Alert variant="danger" className="border-0 shadow-sm mb-4">
                                    ...
                                    <p className="mb-3"><strong>Müşterinin Belirttiği Neden:</strong> {selectedOrder.cancelReason || "Neden belirtilmemiş."}</p>
                            ...
                            {selectedOrder.orderStatus === 'cancelled' && selectedOrder.cancelReason && (
                                <Alert variant="light" className="border mb-4">
                                    ...
                                    <strong>İptal Nedeni:</strong> {selectedOrder.cancelReason}
                                </Alert>
                            )}
