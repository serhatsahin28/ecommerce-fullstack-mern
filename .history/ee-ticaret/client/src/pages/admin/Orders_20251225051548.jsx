...
const AdminOrdersPage = () => {
  ...
  const approveCancelOrder = async (orderCode) => {
        try {
            await fetch.post("http://localhost:5000/admin/OrdersCancelApprove", {
                                ...
                                <Alert variant="danger" className="border-0 shadow-sm mb-4">
                                    ...
                                    <div className="d-flex gap-2">
                                        <Button
                                            variant="danger"
                                            size="sm"
                                            onClick={() => approveCancelOrder(selectedOrder.orderCode)}
                                            disabled={updating}
                                        >
                                            <CheckCircle className="me-1" /> İptali Onayla
                                        </Button>
