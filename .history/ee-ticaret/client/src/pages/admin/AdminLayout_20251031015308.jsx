...
const AdminLayout = () => {
  ...
  return (
    <div className="d-flex">
      {/* Sidebar */}
      <div
        className={`bg-dark text-white p-3 position-fixed top-0 start-0 h-100 ${sidebarOpen ? 'd-block' : 'd-none d-md-block'}`}
        style={{ width: '220px', zIndex: 1050, transition: 'transform 0.3s', transform: sidebarOpen ? 'translateX(0)' : 'translateX(-100%)' }}
      >
      ...
      {/* Content */}
      <div className="flex-grow-1 bg-light" style={{ marginLeft: '0', minHeight: '100vh' }}>
