...
const { updateProfileController, addAddressController, deleteAddressController } = require('../controllers/updateProfileController');
...
router.delete('/delete-address/:addressIndex', authMiddleware, deleteAddressController);
