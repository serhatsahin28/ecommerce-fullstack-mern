...
const addressSchema = new mongoose.Schema({
  adres_ismi: { type: String, required: [false, 'Adres ismi zorunludur.'] },
  adres_detay: { type: String, required: [false, 'Adres detayı zorunludur.'] },
  sehir: { type: String, required: [false, 'Şehir bilgisi zorunludur.'] },
  ilce: { type: String, required: [false, 'İlçe bilgisi zorunludur.'] },
  posta_kodu: { type: String, required: [false, 'Posta kodu zorunludur.'] },
