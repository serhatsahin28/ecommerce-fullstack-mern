...
async function addPaymentMethod(req, res) {
  try {
    ...
    const [month, year] = req.body.son_kullanma.split('/');
    ...
    iyzipay.card.create({
      ...
      card: {
        ...
        cardHolderName: req.body.kart_ismi,
        cardNumber: req.body.kart_numarasi,
        expireMonth: month,
        expireYear: year
      }

    }, async (err, result) => {
      console.log("İyzico raw response:", { err, result,req.body.kart_numarasi });
      if (err) {
