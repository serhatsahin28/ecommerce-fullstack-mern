...
const deleteAddressController = async (req, res) => {
  try {
    ...
    // ÖNEMLİ: user.findById ve user.save KULLANMIYORUZ.
    // Direkt atomik güncelleme yapıyoruz.
    const updatedUser = await users.findByIdAndUpdate(
      ...
      { 
        new: true, 
        runValidators: false // Kritik satır: Bozuk olan diğer adresleri denetleme!
      }
    );
