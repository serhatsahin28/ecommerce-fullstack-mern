...
const payWithSavedCard = async = (req, res) => {

  const { kart_numarasi, son_kullanma, cvv, buyerInfo, basketItems, price } = req.body;
  const [expireMonth, expireYear] = son_kullanma.split('/');
  ...
  const request = {
    ...
    billingAddress: buyerInfo.address,
    basketItems
  };
...
module.exports = { payWithCard,payWithSavedCard };