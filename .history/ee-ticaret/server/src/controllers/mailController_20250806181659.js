...
const sendOrderLink = async (req, res) => {
    try {
        ...
        // Mail gönderme kısmını yorum satırına alalım
        /*
        ...
        */
        ...
        // Token oluşturuldu, yanıt dönelim
        res.status(200).json({
            success: true,
            message: `${email} için token oluşturuldu. Konsolu kontrol edin.`,
            token: token // istersen response'a da ekleyebilirsin
        });
