  ...
  try {
    ...
    if (isSavedCard && savedCardToken) {
      ...
      if (savedCardToken.kart_token && savedCardToken.card_user_key) {
        ...
        // DÜZELTME: Kart bilgilerini de gönder
        request.paymentCard = {
          cardHolderName: savedCardToken.kart_ismi,
          // Masked number yerine token kullanıyoruz, bu yüzden bu alan önemli değil
          cardNumber: '0000000000000000', // Dummy değer
          expireMonth: '01', // Dummy değer
          expireYear: '2030', // Dummy değer
          cvc: cvc.toString(),
          registerCard: "0"
        };
