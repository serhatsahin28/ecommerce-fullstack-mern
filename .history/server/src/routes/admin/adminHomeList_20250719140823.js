...
const { getHomeList, updateHomeList, saveHomePageData, uploadHomeImage,deleteItem } = require('../../controllers/admin/adminHomeController');
...
router.delete('/admin/:index/:itemId',deleteItem);
