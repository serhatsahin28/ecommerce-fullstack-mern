...
const uploadHomeImage = async (req, res) => {
  try {
    ...
    // Dosya yolunu oluştur (public/uploads/home/ klasörüne kaydet)
    const imagePath = `/uploads/home/${file.filename}`;
    
    console.log("Resim yolu:", imagePath);
    ...
    res.status(500).json({ message: 'Resim yükleme sırasında hata oluştu.' });
  }
};
